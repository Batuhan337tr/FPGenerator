...
GOLDENEYE_BANNER = 'Coded By EfeBey'
...
class GoldenEye(object):
    ...
    def fire(self):
        ...
        self.printHeader()
        print "CTRL^C TO STOP DOWN".format(self.method, self.nr_workers, self.nr_sockets)
...
def usage():
    ...
    print GOLDENEYE_BANNER
    print 
    print ' USAGE: ./batuhan337tr.py <url> [OPTIONS]'
    print
    print ' OPTIONS:'
